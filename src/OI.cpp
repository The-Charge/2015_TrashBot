...
OI::OI() {
	...
	winchPositionSwitchL = new JoystickButton(buttonBox, 11);
	winchPositionSwitchL->WhileHeld(new WinchPositionSelector());
	winchPositionSwitchM = new JoystickButton(buttonBox, 10);
	winchPositionSwitchM->WhileHeld(new WinchPositionSelector());
	winchPositionSwitchH = new JoystickButton(buttonBox, 9);
	winchPositionSwitchH->WhileHeld(new WinchPositionSelector());
...
//	SmartDashboard::PutData("LiftXTicks", new LiftXTicks());
	...
	SmartDashboard::PutData("WinchPositionSelector", new WinchPositionSelector());
