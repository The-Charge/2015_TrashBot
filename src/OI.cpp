...
#include "Commands/BinRetrievalRaiseRight.h"
#include "Commands/BinRetrievalRaiseLeft.h"
#include "Commands/BinRetrievalLowerBoth.h"
#include "Commands/BinRetrievalRaiseBoth.h"
...
OI::OI() {
	...
	BothReeperArmsUp = new JoystickButton(buttonBox, 11);
	BothReeperArmsUp -> WhileHeld (new BinRetrievalRaiseBoth());
	BothReeperArmsDown = new JoystickButton(buttonBox, 12);
	BothReeperArmsDown -> WhileHeld(new BinRetrievalLowerBoth());
	...
	LeftReeperArmUp = new JoystickButton(joystick2, 1);
	LeftReeperArmUp -> WhileHeld (new BinRetrievalRaiseLeft());
	RightReeperArmUp = new JoystickButton(joystick1, 1);
	RightReeperArmUp -> WhileHeld (new BinRetrievalRaiseRight());
