...
OI::OI() {
	...
	armsIn = new JoystickButton(joystick2, 12);
	armsIn->WhenPressed(new ParallelArmsIn());
	armsOut = new JoystickButton(joystick2, 11);
	armsOut->WhenPressed(new ParallelArmsOut());
	downSlow = new JoystickButton(joystick2, 10);
	downSlow->WhileHeld(new LiftDownSlow());
	downFast = new JoystickButton(joystick2, 9);
	downFast->WhileHeld(new LiftDownFast());
	upSlow = new JoystickButton(joystick2, 8);
	upSlow->WhileHeld(new LiftUpSlow());
	upFast = new JoystickButton(joystick2, 7);
	upFast->WhileHeld(new LiftUpFast());
