...
#include "Commands/AutonGreenBins.h"
...
*/
	...
	chooser->AddDefault("AutonStrategyPush", new AutonStrategyPush());
	chooser->AddObject ("AutonGreenBins", new AutonGreenBins());
	chooser->AddObject ("Auton2HardYellowTotes",new Auton2HardYellowTotes());
	chooser->AddObject ("Auton3ToteStack", new Auton3ToteStack());

	SmartDashboard::PutData ("Auton Mode Chooser", chooser);
}
