...
void Robot::RobotInit() {
	...
	chooser -> AddDefault ("PushOtherRobot", AutoPush);
	chooser -> AddObject ("PushGreenBins", pushGreenBins);
	chooser -> AddObject ("Auton2HardYellowTotes", ToteStack2Auton);
	chooser -> AddObject ("Auton3ToteStack", ToteStack3Auton);
