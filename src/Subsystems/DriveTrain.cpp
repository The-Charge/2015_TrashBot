...
#include "../RobotMap.h"
#include "../Util/AverageEncodersPIDInput.h"
...
DriveTrain::DriveTrain() :
	...
	//*******************************************************
	robotStrafePIDOutput = new RobotStrafePIDOutput(robotDrive, driveGyro);
	averageEncoderPIDInput = new AverageEncodersPIDInput(CANTalonLeftFront, CANTalonLeftRear, CANTalonRightFront, CANTalonRightRear);

	strafePIDController = new PIDController(0, 0, 0, averageEncoderPIDInput, robotStrafePIDOutput);
...
void DriveTrain::SetPIDControllerOutputRange(float maxpercent) {
	...
	strafePIDController->SetOutputRange(-1 * maxpercent, maxpercent);
...
//	strafePIDOutput =
	...
	strafePIDController->SetSetpoint(TICKS_NEEDED);
	strafePIDController->Enable();
