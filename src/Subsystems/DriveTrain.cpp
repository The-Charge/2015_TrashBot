...
DriveTrain::DriveTrain() :
	...
	CANTalonRightFront->SetSensorDirection(false); //was true
	CANTalonRightRear->SetSensorDirection(false);  //was true
	CANTalonLeftFront->SetSensorDirection(false); //was false
	CANTalonLeftRear->SetSensorDirection(false);  //was false
