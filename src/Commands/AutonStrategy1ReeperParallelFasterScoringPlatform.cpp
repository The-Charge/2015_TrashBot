#include "AutonStrategy1ReeperParallelFasterScoringPlatform.h"
...
AutonStrategy1ReeperParallelFasterScoringPlatform::AutonStrategy1ReeperParallelFasterScoringPlatform()
{
	// Add Commands here:
	...
	AddParallel (new DriveXFeetReeper(-.75, .25) );
		...
		AddSequential (new DriveXFeet(10, .8));
