...
Drive2Feet::Drive2Feet() {
	...
	p = 0;
	TICKS_NEEDED = Robot::driveTrain->ENCODER_TICKS_PER_REVOLUTION * 10;//Robot:: driveTrain -> WHEELROTATIONS_PER_FOOT * 20 * Robot::driveTrain -> ENCODER_TICKS_PER_REVOLUTION;
	SmartDashboard:: PutNumber ("Ticks Needed", TICKS_NEEDED);

	SmartDashboard::PutNumber("Integral constant" , .00);
	SmartDashboard::PutNumber("Closed loop ramp rate" , 6);
}
