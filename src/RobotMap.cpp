...
void RobotMap::init() {
	...
	lw->AddActuator("DriveTrain", "CanTalonLeftFront",driveTrainCANTalonLeftFront );
	driveTrainCANTalonLeftRear = new CANTalon(8);
	lw->AddActuator("DriveTrain", "CanTalonLeftRear",driveTrainCANTalonLeftRear );

	driveTrainCANTalonRightFront = new CANTalon(6);
	lw->AddActuator("DriveTrain", "CanTalonRightFront",driveTrainCANTalonRightFront );

	driveTrainCANTalonRightRear = new CANTalon(9);
	lw->AddActuator("DriveTrain", "CanTalonRightRear",driveTrainCANTalonRightRear );
	...
	//lw->AddActuator("DriveTrain","RobotDrive", driveTrainRobotDrive);
