...
SpeedController* RobotMap::binRetrievalSpeedController = NULL;
DoubleSolenoid* RobotMap::binRetrievalSolenoid = NULL;
...
void RobotMap::init() {
	...
	binRetrievalSpeedController = new TalonSRX(1);
	lw -> AddActuator("BinRetrieval", "SpeedController", (TalonSRX*) binRetrievalSpeedController);
	...
	binRetrievalSolenoid = new DoubleSolenoid (0, 6, 7);
	lw -> AddActuator("BinRetrievalPneumatic", "Bin", binRetrievalSolenoid);
