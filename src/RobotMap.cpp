...
SpeedController* RobotMap::binRetrievalSpeedControllerRight = NULL;
SpeedController* RobotMap::binRetrievalSpeedControllerLeft = NULL;
...
void RobotMap::init() {
	...
	lw -> AddActuator("BinRetrieval", "SpeedController", (TalonSRX*) binRetrievalSpeedControllerRight);
